...
public class MeetingSqlProvider {
    ...
    public String countByExample(MeetingExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("meeting");
    ...
    public String deleteByExample(MeetingExample example) {
        BEGIN();
        DELETE_FROM("meeting");
        applyWhere(example, false);
        return SQL();
    ...
    public String selectByExample(MeetingExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Meeting record = (Meeting) parameter.get("record");
        MeetingExample example = (MeetingExample) parameter.get("example");
        ...
        if (record.getMeetingNumber() != null) {
            SET("meeting_number = #{record.meetingNumber,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(MeetingExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
